...
import sys
# to get the single file name on the command line
if len(sys.argv) == 1: # I just want the single file name on the command line in order to open the textfile, i.e. Solution-9 is the argument
    print ("Opening textfile now") # Print confirmation the textfile is opening as if condition was met
    ...
    print("You should enter a single filename")
